...
export const CODE_OF_CONDUCT =
  process.env.NEXT_PUBLIC_CODE_OF_CONDUCT_URL || '/';
export const REPO = process.env.NEXT_PUBLIC_REPO_URL || '';
export const SAMPLE_TICKET_NUMBER = 1234;

export const NAVIGATION = [
  { name: 'Live Stage', route: '/stage/a' },
  { name: 'Engineering Stage', route: '/stage/c' },
  { name: 'Community Stage', route: '/stage/m' },
